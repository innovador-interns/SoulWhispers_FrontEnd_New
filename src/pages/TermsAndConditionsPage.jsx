...
export default function TermsAndConditionsPage() {
    const [active, setActive] = useState(termsData[0].title);
    ...
    useLayoutEffect(() => {
        const ctx = gsap.context(() => {
            ...
            // Animate Hero
            const split = new SplitText(".terms-hero-title", { type: "words,chars" });
            ...
            <div className="container mx-auto flex gap-12 lg:gap-20 px-6 sm:px-12 relative">
                ...
                <main className="flex-1 pb-20 pt-10 max-w-3xl relative z-10">
                    ...
                    <div className="mb-24">
                        ...
                        <h1 className="terms-hero-title text-3xl md:text-5xl font-bold tracking-tight text-[#0f4f24] leading-[1.1] mb-8">
                            Terms and Conditions.
                        </h1>
                        <p className="text-slate-500 text-base md:text-lg max-w-xl leading-relaxed">
                            Clear guidelines for a safe, respectful, and beneficial experience on our platform. Your trust and safety come first.
                        </p>
                    </div>
